...
app.post("/user/login", function (req, res) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, app_data_source_1.myDataSource.getRepository(user_entity_1.User).findOneBy({ pin: req.body.pin })];
                case 1:
                    user = _a.sent();
...
app.post("/product", function (req, res) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, app_data_source_1.myDataSource.getRepository(product_entity_1.Product).findOneBy({ sku: req.body.sku })];
                case 1:
                    prod = _a.sent();
                    return [2 /*return*/, res.send(prod)];
            }
        });
    });
});
...
app.delete("/users/delete", function (req, res) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, app_data_source_1.myDataSource.getRepository(user_entity_1.User).delete({ id: req.body.id })];
                case 1:
                    results = _a.sent();
                    return [2 /*return*/, res.send(results)];
            }
